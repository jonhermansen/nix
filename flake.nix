{
  ...
  inputs.nixpkgs.url = "github:NixOS/bsdpkgs/bsdos-unstable";

  inputs.nixpkgs-regression.url = "github:NixOS/bsdpkgs/215d4d0fd80ca5163643b03a33fde804a29cc1e2";
  inputs.nixpkgs-23-11.url = "github:NixOS/bsdpkgs/a62e6edd6d5e1fa0329b8653c801147986f8d446";
  inputs.flake-compat = {
  ...
  # work around https://github.com/NixOS/bsd/issues/7730
  inputs.flake-parts.inputs.nixpkgs-lib.follows = "nixpkgs";
  inputs.git-hooks-nix.inputs.nixpkgs.follows = "nixpkgs";
  inputs.git-hooks-nix.inputs.nixpkgs-stable.follows = "nixpkgs";
  # work around 7730 and https://github.com/NixOS/bsd/issues/7807
  ...
  outputs =
    ...
    let
      ...
      crossSystems = [
        ...
        # Disabled because of https://github.com/NixOS/bsdpkgs/issues/344423
      ...
      /**
        ...
        See https://bsdos.org/manual/bsdpkgs/stable/index.html#function-library-lib.attrsets.concatMapAttrs
      */
          ...
          flatMapAttrs
            (
              ...
              // lib.optionalAttrs (!nixpkgsFor.${system}.native.stdenv.hostPlatform.isDarwin) {
                ...
                #       https://github.com/NixOS/bsdpkgs/issues/320448
