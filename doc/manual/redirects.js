...
const redirects = {
 "index.html": {
    ...
    "sec-nix-build": "command-ref/bsd-build.html",
    "sec-nix-channel": "command-ref/bsd-channel.html",
    "sec-nix-collect-garbage": "command-ref/bsd-collect-garbage.html",
    "sec-nix-copy-closure": "command-ref/bsd-copy-closure.html",
    "sec-nix-daemon": "command-ref/bsd-daemon.html",
    "refsec-nix-env-install-examples": "command-ref/bsd-env.html#examples",
    "rsec-nix-env-install": "command-ref/bsd-env.html#operation---install",
    "rsec-nix-env-set": "command-ref/bsd-env.html#operation---set",
    "rsec-nix-env-set-flag": "command-ref/bsd-env.html#operation---set-flag",
    "rsec-nix-env-upgrade": "command-ref/bsd-env.html#operation---upgrade",
    "sec-nix-env": "command-ref/bsd-env.html",
    "ssec-version-comparisons": "command-ref/bsd-env.html#versions",
    "sec-nix-hash": "command-ref/bsd-hash.html",
    "sec-nix-instantiate": "command-ref/bsd-instantiate.html",
    "sec-nix-prefetch-url": "command-ref/bsd-prefetch-url.html",
    "sec-nix-shell": "command-ref/bsd-shell.html",
    "ssec-nix-shell-shebang": "command-ref/bsd-shell.html#use-as-a--interpreter",
    "nixref-queries": "command-ref/bsd-store.html#queries",
    "opt-add-root": "command-ref/bsd-store.html#opt-add-root",
    "refsec-nix-store-dump": "command-ref/bsd-store.html#operation---dump",
    "refsec-nix-store-export": "command-ref/bsd-store.html#operation---export",
    "refsec-nix-store-import": "command-ref/bsd-store.html#operation---import",
    "refsec-nix-store-query": "command-ref/bsd-store.html#operation---query",
    "refsec-nix-store-verify": "command-ref/bsd-store.html#operation---verify",
    "rsec-nix-store-gc": "command-ref/bsd-store.html#operation---gc",
    "rsec-nix-store-generate-binary-cache-key": "command-ref/bsd-store.html#operation---generate-binary-cache-key",
    "rsec-nix-store-realise": "command-ref/bsd-store.html#operation---realise",
    "rsec-nix-store-serve": "command-ref/bsd-store.html#operation---serve",
    "sec-nix-store": "command-ref/bsd-store.html",
    ...
    "ch-nix-security": "installation/bsd-security.html",
