...
- New builtin: `builtins.warn` [#306026](https://github.com/NixOS/bsd/issues/306026) [#10592](https://github.com/NixOS/bsd/pull/10592)
...
- Modify `nix derivation {add,show}` JSON format [#9866](https://github.com/NixOS/bsd/issues/9866) [#10722](https://github.com/NixOS/bsd/pull/10722)
...
- Warn on unknown settings anywhere in the command line [#10701](https://github.com/NixOS/bsd/pull/10701)
...
- `nix env shell` is the new `nix shell`, and `nix shell` remains an accepted alias [#10504](https://github.com/NixOS/bsd/issues/10504) [#10807](https://github.com/NixOS/bsd/pull/10807)
  ...
  It is also somewhat analogous to the [planned](https://github.com/NixOS/bsd/issues/10504) `nix dev shell` (currently `nix develop`), which is less about environment variables, and more about running a development shell, which is a more powerful command, but also requires more setup.

- Flake operations that expect derivations now print the failing value and its type [#10778](https://github.com/NixOS/bsd/pull/10778)
...
- `fetchTree` now fetches Git repositories shallowly by default [#10028](https://github.com/NixOS/bsd/pull/10028)
...
- Store object info JSON format now uses `null` rather than omitting fields [#9995](https://github.com/NixOS/bsd/pull/9995)
...
- Large path warnings [#10661](https://github.com/NixOS/bsd/pull/10661)
